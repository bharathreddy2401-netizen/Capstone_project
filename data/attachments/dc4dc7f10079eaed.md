...
- Name: InterfaceFunctionality.spec.js >> Testing the Interface Functionality >> Testing Product review block in products page with wrong email format
- Location: tests/InterfaceFunctionality.spec.js:179:9
