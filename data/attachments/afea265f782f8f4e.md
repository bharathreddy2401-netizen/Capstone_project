...
- Name: InterfaceFunctionality.spec.js >> Testing the Interface Functionality >> Testing the Subscription block validation with wrong email format
- Location: tests/InterfaceFunctionality.spec.js:121:9
