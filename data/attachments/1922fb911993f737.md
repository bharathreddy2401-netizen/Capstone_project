...
Expected: 500
Received: {"_apiName": "Locator", "_frame": {"_guid": "frame@ef2b43ad873fcafe1f811826b34737f6", "_type": "Frame"}, "_selector": "#cart_info table tbody tr.cart_price", Symbol(nodejs.util.inspect.custom): [Function anonymous]}
```
...
```ts
  ...
  42 |         const firstPrice = page.locator("#cart_info table tbody tr.cart_price");
