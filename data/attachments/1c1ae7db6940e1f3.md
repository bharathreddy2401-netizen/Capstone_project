...
- Name: Cart.spec.js >> Testing the Cart Functionality without login >> Testing the cart products to be visible in multiple browser tabs
- Location: tests/Cart.spec.js:74:9
