...
- Name: checkout.spec.js >> Testing the checkout functionality of the automation exercise >> Testing the Review your order after checkout button
- Location: tests/checkout.spec.js:110:10
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e4]:
      ...
      - link "WebMaster" [ref=e5] [cursor=pointer]:
        - /url: mailto:webmaster@automationexercise.com?subject=Error message [403] (none) for automationexercise.com/ port 443 on Wednesday, 03-Jun-2026 22:20:21 MST
      - text: .
