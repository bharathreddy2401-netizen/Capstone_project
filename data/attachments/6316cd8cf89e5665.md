...
Expected: "1"
Received: {"_apiName": "Locator", "_frame": {"_guid": "frame@cb923b62142004b49268f25b358749a9", "_type": "Frame"}, "_selector": ".disabled", Symbol(nodejs.util.inspect.custom): [Function anonymous]}
```
...
> 19 |         await expect(page.locator(".disabled")).toBe("1");
     |                                                 ^ Error: expect(received).toBe(expected) // Object.is equality
  20 |        // await cart.add();
  21 |         //await cart.add();
  22 |     })
