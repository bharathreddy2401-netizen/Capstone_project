...
Expected: 500
Received: {"_apiName": "Locator", "_frame": {"_guid": "frame@cc4f99af01af36f5cf423ffaeb22e971", "_type": "Frame"}, "_selector": "#product-1.cart_price", Symbol(nodejs.util.inspect.custom): [Function anonymous]}
```
...
```ts
  ...
  42 |         const firstPrice = page.locator("#product-1.cart_price");
