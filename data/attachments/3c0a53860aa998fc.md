...
- Name: Login.spec.js >> Testing the Login Page >> Testing Login form Submission by pressing Enter key instead of clicking login button
- Location: tests/Login.spec.js:24:9
