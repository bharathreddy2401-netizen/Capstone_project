...
Expected: 500
Received: {"_apiName": "Locator", "_frame": {"_guid": "frame@13b9f42bf80e170b443dccce87114442", "_type": "Frame"}, "_selector": "#cart_info table tbody tr td.cart_price", Symbol(nodejs.util.inspect.custom): [Function anonymous]}
```
...
```ts
  ...
  42 |         const firstPrice = page.locator("#cart_info table tbody tr td.cart_price");
> 43 |         await expect(firstPrice).toBe(500);
     |                                  ^ Error: expect(received).toBe(expected) // Object.is equality
  44 |     })
  45 | })
```