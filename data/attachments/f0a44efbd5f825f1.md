...
- Name: Payment.spec.js >> Testing the Payment Page >> Testing clicking on place order button redirect us to the payment page 
- Location: tests/Payment.spec.js:22:9
