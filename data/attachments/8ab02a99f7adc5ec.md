...
- Name: Cart.spec.js >> Testing the Cart Functionality without login >> Testing the empty cart by directly going to cart without adding products
- Location: tests/Cart.spec.js:18:9
...
Call log:
  - waiting for getByRole('link', { name: 'Cart' }).first()
    6 × waiting for" https://automationexercise.com/" navigation to finish...
