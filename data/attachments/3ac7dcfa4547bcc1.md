...
- Name: InterfaceFunctionality.spec.js >> Testing the Interface Functionality >> Testing the view product displays the product details without missing any data
- Location: tests/InterfaceFunctionality.spec.js:78:9
...
Locator: getByRole('heading', { name: 'Sleeveless Dress' })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Sleeveless Dress' })
