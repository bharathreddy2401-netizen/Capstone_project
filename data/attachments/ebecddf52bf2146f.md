...
- Name: InterfaceFunctionality.spec.js >> Testing the Interface Functionality >> Testing the brand filter navigates to that brand products page
- Location: tests/InterfaceFunctionality.spec.js:48:9
