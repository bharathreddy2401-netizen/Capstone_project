...
- Name: Cart.spec.js >> Testing the Cart Functionality without login >> Testing the multiplied price of products in the cart is correct
- Location: tests/Cart.spec.js:55:9
