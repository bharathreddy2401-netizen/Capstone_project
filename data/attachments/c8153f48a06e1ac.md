...
- Name: SignUp.spec.js >> Enter account information page testing >> Missing the Mandetory Country field
- Location: tests\SignUp.spec.js:197:9
      ...
      - generic [ref=e43]:
        ...
        - generic [ref=e58]:
          - generic [ref=e59]:
            - text: Email
            - superscript [ref=e60]: "*"
          - textbox "Email *" [disabled] [ref=e61]: user_1779768089245@example.com
        - generic [ref=e62]:
          - generic [ref=e63]:
            - text: Password
            - superscript [ref=e64]: "*"
  ...
  - insertion [ref=e138]:
    - iframe [ref=e141]:
      - generic [active] [ref=f24e1]:
        - img [ref=f24e5] [cursor=pointer]
        - button [ref=f24e7] [cursor=pointer]:
          - img [ref=f24e8]
        - generic [ref=f24e18]:
          - generic [ref=f24e20]:
            - button "Replay" [ref=f24e26]:
              - img [ref=f24e28] [cursor=pointer]
            - img [ref=f24e33]
          - button "Learn more" [ref=f24e40] [cursor=pointer]
```
