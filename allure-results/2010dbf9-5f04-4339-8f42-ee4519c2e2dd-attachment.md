...
- Name: SignUp.spec.js >> Enter account information page testing >> Missing the Mandetory city field
- Location: tests\SignUp.spec.js:173:9
      ...
      - generic [ref=e43]:
        ...
        - generic [ref=e58]:
          - generic [ref=e59]:
            - text: Email
            - superscript [ref=e60]: "*"
          - textbox "Email *" [disabled] [ref=e61]: user_1779768095698@example.com
        - generic [ref=e62]:
          - generic [ref=e63]:
            - text: Password
            - superscript [ref=e64]: "*"
          - textbox "Password *" [active] [ref=e65]: 12345@
        - generic [ref=e66]:
  ...
  - insertion [ref=e146]:
    - iframe [ref=e149]:
      - generic [active] [ref=f30e1]:
        - img [ref=f30e5] [cursor=pointer]
        - button [ref=f30e7] [cursor=pointer]:
          - img [ref=f30e8]
        - generic [ref=f30e18]:
          - generic [ref=f30e20]:
            - button "Replay" [ref=f30e26]:
              - img [ref=f30e28] [cursor=pointer]
            - img [ref=f30e33]
          - button "Learn more" [ref=f30e40] [cursor=pointer]
```
